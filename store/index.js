...
export const state = () => ({
  ...
  project: {
    ...
    list: [
      ...
      { id: 2, name: 'MyProject02MyProject02MyProject02MyProject02MyProject02MyProject02MyProject02MyProject02', updatedAt: '2020-04-05T12:00:00+09:00' },
...
// state, getters, commit, dispatch, rootState, rootGettersを引数として取れる
